...
void infrared_scene_edit_pin_done_on_enter(void* context) {
...
bool infrared_scene_edit_pin_done_on_event(void* context, SceneManagerEvent event) {
    Infrared* infrared = context;
...
void infrared_scene_edit_pin_done_on_exit(void* context) {
    Infrared* infrared = context;
    UNUSED(infrared);
}
